...
echo 
tamarin_file="model/wpa2_four_way_handshake_with_aoci.spthy"
ut_tamarin="./proof_generation/ut_tamarin/build/bin/uttamarin"
$ut_tamarin $tamarin_file --timeout=60 --config_file=./proof_generation/utt_config.json --proof_directory=automatic_proofs ${@:1}
